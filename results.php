...
<body>
    ...
    <div class="container">
        <div class="wrapper">
            <div class="indicator">
                ...
                <div class="sort-by-box">
                    <label for="sort-select">Availability:</label>
                    <br>
                        <select id="sort-select">
                            <option value="relevance">Available</option>
                            <option value="newest-oldest">Borrowed</option>
                        </select>
                </div>
                <div class="sort-by-box">
                    <label for="sort-select">Year Publication:</label>
                    <br>
                        <input type="year" id="year-from" placeholder="From:" min="1900" max="2023" style="width:15%;">
                        <input type="year" id="year-to" placeholder="To:" min="1900" max="2023" style="width:15%;">

                </div>
                <div class="sort-by-box">
                    <label for="sort-select">Resource Type:</label>
                    <br>
                        <select id="sort-select" style="width:40%;">
                            <option value="relevance">Books</option>
                            <option value="newest-oldest">Thesis/Capstone</option>
                            <option value="relevance">Newspaper Article</option>
                            <option value="relevance">Magazine Articles</option>
                            <option value="relevance">Journal Articles</option>
                        </select>
                </div>
            </div>
        </div>
  ...
  if (year < 1900 || year > 2023) {
    alert("Please enter a valid year between 1900 and 2023.");
    input.value = "";
    return false;
  }
  return true;
...
yearFromInput.addEventListener("blur", validateYear);

const yearToInput = document.getElementById("year-to");
yearToInput.addEventListener("blur", validateYear);
